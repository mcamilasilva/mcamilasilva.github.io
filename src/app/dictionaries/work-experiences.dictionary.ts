...
const english = [
    ...
    new WorkExperience([PositionEnum.INTERMEDIATE_SOFTWARE_DEVELOPER], CompanyEnum.OPUS, new Period(new MonthYear(MonthEnum.NOV, 2017), new MonthYear(MonthEnum.NOV, 2019)),
    ...
    new WorkExperience([PositionEnum.WEB_DEVELOPER], CompanyEnum.AUDAXWARE, new Period(new MonthYear(MonthEnum.NOV, 2015), new MonthYear(MonthEnum.NOV, 2017)),
    ...
    new WorkExperience([PositionEnum.SYSTEM_ANALYST], CompanyEnum.OPUS, new Period(new MonthYear(MonthEnum.JAN, 2015), new MonthYear(MonthEnum.NOV, 2015)),
