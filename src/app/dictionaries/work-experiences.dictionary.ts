...
const english = [
    new WorkExperience('Senior Software Developer / Tech Lead', CompanyEnum.OPUS, new Period(new MonthYear(MonthEnum.NOV, 2019)),
    ...
    new WorkExperience('Software Developer', CompanyEnum.OPUS, new Period(new MonthYear(MonthEnum.NOV, 2017), new MonthYear(MonthEnum.NOV, 2019)),
    ...
    new WorkExperience('Web Developer', CompanyEnum.AUDAXWARE, new Period(new MonthYear(MonthEnum.NOV, 2015), new MonthYear(MonthEnum.NOV, 2017)),
    ...
    new WorkExperience('System Analyst', CompanyEnum.OPUS, new Period(new MonthYear(MonthEnum.JAN, 2015), new MonthYear(MonthEnum.NOV, 2015)),
...
const portuguese = [
    new WorkExperience('Desenvolvedora Sênior / Tech Lead', CompanyEnum.OPUS, new Period(new MonthYear(MonthEnum.NOV, 2019)),
        ...
        ["Java11", "Spring Boot", "Angular 6", "PostgreSQL", "AWS", "Git", "Jira", "Scrum", "Jenkins"]),
    new WorkExperience('Desenvolvedora Pleno', CompanyEnum.OPUS, new Period(new MonthYear(MonthEnum.NOV, 2017), new MonthYear(MonthEnum.NOV, 2019)),
        ...
        ["Java8, Spring Boot, Angular 2, My SQL, AWS, Git, Jira, Scrum, Jenkins"]),
    new WorkExperience('Desenvolvedora Web', CompanyEnum.AUDAXWARE, new Period(new MonthYear(MonthEnum.NOV, 2015), new MonthYear(MonthEnum.NOV, 2017)),
        ...
        ["C#, SQL Server, AngularJS, Kendo UI, Material, Azure, Web Job, TFS, Kanban"]),
    new WorkExperience('Analista de Sistemas', CompanyEnum.OPUS, new Period(new MonthYear(MonthEnum.JAN, 2015), new MonthYear(MonthEnum.NOV, 2015)),
